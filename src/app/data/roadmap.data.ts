...
export const roadmapData: RoadmapCategory[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'graceful-shutdown', title: 'Graceful Shutdown', description: 'Shut down a live server while requests are running, then watch a clean drain and a hard kill produce completely different outcomes.', status: 'interactive', visualizationType: 'graceful-shutdown', route: '/explore/graceful-shutdown' },
